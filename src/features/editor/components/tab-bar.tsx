...
const TabItem = ({
  ...
  return (
    <div onClick={()=>{setActiveTab(projectId, tabId)}} className={cn('flex group items-center ', { 'bg-muted': isActive })}>
          <div className="flex items-center mx-1" >
              
            <span>{tabName}</span>
       <XIcon onClick={() => handleClose(projectId, tabId)} className="size-2.5 m-1 opacity-0 group-hover:opacity-100 transition hover:bg-gray-600 hover:scale-150 " />
